...
{
    public sealed partial class Receiving_EditModeView : UserControl
    {
        public Receiving_EditModeViewModel ViewModel { get; }

        public Receiving_EditModeView()
        {
            ViewModel = App.GetService<Receiving_EditModeViewModel>();
