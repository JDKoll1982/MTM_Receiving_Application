...
namespace MTM_Receiving_Application.Views.Shared
{
    ...
    /// </summary>
    public sealed partial class Shared_SplashScreenWindow : Window
    {
        private const int WindowWidth = 850;
        private const int WindowHeight = 700;

        public Shared_SplashScreenViewModel ViewModel { get; }
        ...
        public Shared_SplashScreenWindow(Shared_SplashScreenViewModel viewModel)
        {
            ViewModel = viewModel;
            InitializeComponent();
