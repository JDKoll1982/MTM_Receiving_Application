...
namespace MTM_Receiving_Application.Views.Shared
{
    ...
    /// </summary>
    public sealed partial class NewUserSetupDialog : ContentDialog
    {
        public NewUserSetupViewModel ViewModel { get; }

        /// <summary>
        /// Constructor with ViewModel injection
        /// </summary>
        public NewUserSetupDialog(NewUserSetupViewModel viewModel)
        {
            InitializeComponent();
