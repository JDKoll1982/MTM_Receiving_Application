...
{
    public sealed partial class Dunnage_EditModeView : UserControl
    {
        public Dunnage_EditModeViewModel ViewModel { get; }

        public Dunnage_EditModeView()
        {
            ViewModel = App.GetService<Dunnage_EditModeViewModel>();
