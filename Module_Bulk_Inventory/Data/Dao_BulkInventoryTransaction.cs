...
public class Dao_BulkInventoryTransaction
{
    ...
    public async Task<Model_Dao_Result<int>> InsertAsync(Model_BulkInventoryTransaction row)
    {
        ...
        catch (Exception ex)
        {
            return Model_Dao_Result_Factory.Failure<int>(
                $"Error inserting bulk inventory transaction: {ex.Message}",
                ex
            );
        }
    }
    ...
    public async Task<Model_Dao_Result> UpdateAsync(Model_BulkInventoryTransaction row)
    {
        ...
        catch (Exception ex)
        {
            return Model_Dao_Result_Factory.Failure(
                $"Error updating bulk inventory transaction: {ex.Message}",
                ex
            );
        }
    }
    ...
    )
    {
        ...
        {
            return Model_Dao_Result_Factory.Failure(
                $"Error updating bulk inventory transaction status: {ex.Message}",
                ex
            );
        }
    }
    ...
    )
    {
        try
        {
            ...
            return await Helper_Database_StoredProcedure.ExecuteListAsync(
                ...
                reader => new Model_BulkInventoryTransaction
                {
                    ...
                    Status = Enum.Parse<Enum_BulkInventoryStatus>(reader["status"].ToString()!),
        ...
        catch (Exception ex)
        {
            return Model_Dao_Result_Factory.Failure<List<Model_BulkInventoryTransaction>>(
                $"Error retrieving bulk inventory transactions: {ex.Message}",
                ex
            );
        }
    }
    ...
    public async Task<Model_Dao_Result> DeleteByIdAsync(int id)
    {
        ...
        {
            return Model_Dao_Result_Factory.Failure(
                $"Error deleting bulk inventory transaction: {ex.Message}",
                ex
            );
        }
    }
