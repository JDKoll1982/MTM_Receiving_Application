...
/// </summary>
public class Service_Receiving_Business_MySQL_QualityHold : IService_Receiving_Business_MySQL_QualityHold
{
    private readonly Dao_Receiving_Repository_QualityHold _dao;
    private readonly IService_LoggingUtility _logger;

    public Service_Receiving_Business_MySQL_QualityHold(
