...
namespace MTM_Receiving_Application.Module_Receiving.Models
{
    ...
    /// </summary>
    public class Model_Receiving_Result_ValidationResult
    {
        ...
        public static Model_Receiving_Result_ValidationResult Success() => new() { IsValid = true };
        public static Model_Receiving_Result_ValidationResult Error(string message) => new()
        {
            IsValid = false,
        ...
        public static Model_Receiving_Result_ValidationResult Warning(string message) => new()
        {
