...
namespace MTM_Receiving_Application.Module_Receiving.Contracts
{
    ...
    public interface IService_Receiving_Infrastructure_Validation
    {
        ...
        public Task<Model_Receiving_Result_ValidationResult> ValidateAgainstPOQuantityAsync(
        ...
        public Task<Model_Receiving_Result_ValidationResult> CheckSameDayReceivingAsync(
            string poNumber,
            string partID,
        ...
        /// <returns>Validation result</returns>
        public Task<Model_Receiving_Result_ValidationResult> ValidatePartExistsInVisualAsync(string partID);
