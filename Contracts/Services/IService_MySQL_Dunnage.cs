...
namespace MTM_Receiving_Application.Contracts.Services
{
    ...
    public interface IService_MySQL_Dunnage
    {
        ...
        Task<DaoResult<List<Model_DunnageType>>> GetAllTypesAsync();
        Task<DaoResult<Model_DunnageType>> GetTypeByIdAsync(int typeId);
        ...
        Task<DaoResult<List<Model_DunnageSpec>>> GetSpecsForTypeAsync(int typeId);
        ...
        Task<DaoResult<List<Model_DunnagePart>>> GetAllPartsAsync();
        Task<DaoResult<List<Model_DunnagePart>>> GetPartsByTypeAsync(int typeId);
        Task<DaoResult<Model_DunnagePart>> GetPartByIdAsync(string partId);
        ...
        Task<DaoResult<List<Model_DunnagePart>>> SearchPartsAsync(string searchText, int? typeId);

        // ==================== Load Operations (6 methods) ====================

        Task<Model_Dao_Result> SaveLoadsAsync(List<Model_DunnageLoad> loads);
        Task<DaoResult<List<Model_DunnageLoad>>> GetLoadsByDateRangeAsync(DateTime start, DateTime end);
        Task<DaoResult<List<Model_DunnageLoad>>> GetAllLoadsAsync();
        Task<DaoResult<Model_DunnageLoad>> GetLoadByIdAsync(string loadUuid);
        ...
        Task<DaoResult<Model_InventoriedDunnage>> GetInventoryDetailsAsync(string partId);
        Task<DaoResult<List<Model_InventoriedDunnage>>> GetAllInventoriedPartsAsync();
