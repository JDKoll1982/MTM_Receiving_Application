...
public interface IRoutingInforVisualService
{
    ...
    Task<Model_Dao_Result<bool>> ValidatePoNumberAsync(string poNumber);
    ...
    Task<Model_Dao_Result<List<Model_InforVisualPOLine>>> GetPoLinesAsync(string poNumber);
    ...
    Task<Model_Dao_Result<Model_InforVisualPOLine>> GetPoLineAsync(string poNumber, string lineNumber);
    ...
    Task<Model_Dao_Result<bool>> CheckConnectionAsync();
}
