...
>
> - In _Inventory Transfers_ → **To Location**
> - In _Inventory Transaction Entry_ → **Quantity**
...
| [docs/InforVisual/DatabaseCSVFiles/](../../docs/InforVisual/DatabaseCSVFiles/)                                                           | CSV schema exports: Tables, PKs, FKs, Indexes, ColumnDetails      |
...
_Last Updated: 2026-03-08 — Updated to reflect approved corrections_
