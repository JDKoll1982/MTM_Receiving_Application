...
mysql -h 172.16.1.104 -P 3306 -u root -p mtm_receiving_application < StoredProcedures/Authentication/sp_GetUserByWindowsUsername.sql
mysql -h 172.16.1.104 -P 3306 -u root -p mtm_receiving_application < StoredProcedures/Authentication/sp_ValidateUserPin.sql
