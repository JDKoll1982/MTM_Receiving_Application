...
/// </summary>
public partial class ViewModel_Dunnage_PartSelection : Shared_BaseViewModel
{
    ...
    private async Task QuickAddPartAsync()
    {
        try
        {
            ...
            var dialog = new DunnageModule.Views.View_Dunnage_QuickAddPartDialog(SelectedTypeId, SelectedTypeName, specs)
            {
