...
/// </summary>
public partial class ViewModel_Dunnage_AdminInventory : Shared_BaseViewModel
{
    ...
    private async Task ShowAddToListAsync()
    {
        try
        {
            var dialog = App.GetService<DunnageModule.Views.View_Dunnage_Dialog_AddToInventoriedListDialog>();
