...
Add-Entry "Receiving.UiText.Workflow.ResetLabelTable" "Workflow - Reset Label Table Button" "Reset Label Table"
...
Add-Entry "Receiving.UiText.Completion.LocalLabelTableLabel" "Completion - Local Label Table Label" "Local Label Table:"
Add-Entry "Receiving.UiText.Completion.NetworkLabelTableLabel" "Completion - Network Label Table Label" "Network Label Table:"
...
Add-Entry "Receiving.Workflow.SaveProgress.SavingLabelTable" "Workflow - Saving Label Table" "Saving to local and network label table..."
Add-Entry "Receiving.Workflow.Dialog.ResetLabelTable.Title" "Workflow - Reset Label Table Dialog Title" "Reset Label Table Files"
Add-Entry "Receiving.Workflow.Dialog.ResetLabelTable.Content" "Workflow - Reset Label Table Dialog Content" "Are you sure you want to delete the local and network label table files? This action cannot be undone."
Add-Entry "Receiving.Workflow.Dialog.ResetLabelTable.Delete" "Workflow - Reset Label Table Dialog Delete" "Delete"
Add-Entry "Receiving.Workflow.Dialog.ResetLabelTable.Cancel" "Workflow - Reset Label Table Dialog Cancel" "Cancel"
...
Add-Entry "Receiving.Workflow.Status.LabelTableDeletedSuccess" "Workflow - Label Table Deleted Success" "Label table files deleted successfully."
Add-Entry "Receiving.Workflow.Status.LabelTableDeletedFailed" "Workflow - Label Table Deleted Failed" "Failed to delete label table files or files not found."
