...
- Missing service or contract files referenced by name:
  - Module_Reporting/Contracts/Service_Reporting.cs
  - Module_Reporting/Contracts/Service_ReportingClipboard.cs
