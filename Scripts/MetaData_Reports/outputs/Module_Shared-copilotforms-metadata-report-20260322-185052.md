...
- Generated: 2026-03-22T18:50:52
- Module: Module_Shared
- Metadata status: MetadataPresent
- Source file count: 16
- Metadata folder: C:\Users\johnk\source\repos\MTM_Receiving_Application\docs\CopilotForms\data\module-metadata\Module_Shared
...
### Help Dialog (shared-help-dialog.json)

- No broken references detected.

### New User Setup (shared-new-user-setup.json)

- No broken references detected.

### Shared Shell Foundation (shared-shell-foundation.json)

- No broken references detected.

### Splash Screen (shared-splash-screen.json)

- No broken references detected.

### Shared Terminal Login (shared-terminal-login.json)
