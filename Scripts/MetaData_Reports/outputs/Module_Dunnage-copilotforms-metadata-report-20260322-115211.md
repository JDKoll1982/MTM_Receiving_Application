...
- Generated: 2026-03-22T11:52:11
- Module: Module_Dunnage
- Metadata status: MetadataPresent
- Source file count: 87
- Metadata folder: C:\Users\johnk\source\repos\MTM_Receiving_Application\docs\CopilotForms\data\module-metadata\Module_Dunnage
...
### Admin Maintenance (dunnage-admin-maintenance.json)

- No broken references detected.

### Edit Mode And Dialogs (dunnage-edit-and-dialogs.json)

- No broken references detected.

### Guided Workflow (dunnage-guided-workflow.json)

- No broken references detected.

### Dunnage Management (dunnage-management.json)
