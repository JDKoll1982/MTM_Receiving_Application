        ...
        throw new UrlElicitationRequiredError([
            {
                ...
                url: `http://172.16.1.104:${MCP_PORT}/confirm-payment?session=${sessionId}&elicitation=${elicitationId}&cartId=${encodeURIComponent(cartId)}`,
                elicitationId
            }
        ]);
    });
...
const mcpServerUrl = new URL(`http://172.16.1.104:${MCP_PORT}/mcp`);
const authServerUrl = new URL(`http://172.16.1.104:${AUTH_PORT}`);
...
async function sendApiKeyElicitation(sessionId, sender, createCompletionNotifier) {
    ...
    try {
        const result = await sender({
            ...
            url: `http://172.16.1.104:${MCP_PORT}/api-key-form?session=${sessionId}&elicitation=${elicitationId}`,
            elicitationId
        });
