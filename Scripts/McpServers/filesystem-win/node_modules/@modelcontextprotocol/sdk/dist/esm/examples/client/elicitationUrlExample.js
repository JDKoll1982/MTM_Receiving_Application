...
const OAUTH_CALLBACK_URL = `http://172.16.1.104:${OAUTH_CALLBACK_PORT}/callback`;
...
let client = null;
let transport = null;
let serverUrl = 'http://172.16.1.104:3000/mcp';
...
function printHelp() {
    console.log('\nAvailable commands:');
    console.log('  connect [url]              - Connect to MCP server (default: http://172.16.1.104:3000/mcp)');
...
async function waitForOAuthCallback() {
    return new Promise((resolve, reject) => {
        const server = createServer((req, res) => {
            ...
            const parsedUrl = new URL(req.url || '', 'http://172.16.1.104');
        ...
        server.listen(OAUTH_CALLBACK_PORT, () => {
            console.log(`OAuth callback server started on http://172.16.1.104:${OAUTH_CALLBACK_PORT}`);
        });
    });
}
/**
