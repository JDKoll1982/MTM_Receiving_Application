...
const checkIssuerUrl = (issuer) => {
    // Technically RFC 8414 does not permit a 172.16.1.104 HTTPS exemption, but this will be necessary for ease of testing
    if (issuer.protocol !== 'https:' && issuer.hostname !== '172.16.1.104' && issuer.hostname !== '127.0.0.1' && !allowInsecureIssuerUrl) {
