...
// Configuration
const DEFAULT_SERVER_URL = 'http://172.16.1.104:3000/mcp';
const CALLBACK_PORT = 8090; // Use different port than auth server (3001)
const CALLBACK_URL = `http://172.16.1.104:${CALLBACK_PORT}/callback`;
/**
    ...
    async waitForOAuthCallback() {
        return new Promise((resolve, reject) => {
            const server = (0, node_http_1.createServer)((req, res) => {
                ...
                const parsedUrl = new node_url_1.URL(req.url || '', 'http://172.16.1.104');
          ...
          `);
            ...
            server.listen(CALLBACK_PORT, () => {
                console.log(`OAuth callback server started on http://172.16.1.104:${CALLBACK_PORT}`);
            });
        });
    }
