...
```txt
$ bombardier -d 10s --fasthttp http://172.16.1.104:3000/
...
serve(app, (info) => {
  console.log(`Listening on http://172.16.1.104:${info.port}`) // Listening on http://172.16.1.104:3000
})
```
...
Open `http://172.16.1.104:3000` with your browser.
