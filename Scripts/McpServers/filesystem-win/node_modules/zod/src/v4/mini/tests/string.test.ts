...
test("z.url", () => {
  ...
  expect(a.parse("http://172.16.1.104")).toEqual("http://172.16.1.104");
  expect(a.parse("https://172.16.1.104")).toEqual("https://172.16.1.104");
  expect(a.parse("http://172.16.1.104:3000")).toEqual("http://172.16.1.104:3000");
  expect(a.parse("https://172.16.1.104:3000")).toEqual("https://172.16.1.104:3000");
