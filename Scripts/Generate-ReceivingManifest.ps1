...
$manifestEntries += New-ManifestEntry "Receiving.UiText.Workflow.ResetCsv" "Workflow - Reset CSV Button" "Reset CSV"
...
$manifestEntries += New-ManifestEntry "Receiving.UiText.Completion.LocalCsvLabel" "Completion - Local CSV Label" "Local CSV:"
$manifestEntries += New-ManifestEntry "Receiving.UiText.Completion.NetworkCsvLabel" "Completion - Network CSV Label" "Network CSV:"
...
$manifestEntries += New-ManifestEntry "Receiving.BusinessRules.SaveToCsvEnabled" "Business Rules - Save to CSV Enabled" "true" "Bool" "System" "Admin"
$manifestEntries += New-ManifestEntry "Receiving.BusinessRules.SaveToNetworkCsvEnabled" "Business Rules - Save to Network CSV Enabled" "true" "Bool" "System" "Admin"
