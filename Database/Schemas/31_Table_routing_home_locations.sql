...
DROP TABLE IF EXISTS routing_home_locations;

CREATE TABLE IF NOT EXISTS routing_home_locations (
    id INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Primary key: unique identifier for the routing rule',

    -- Rule definition
    match_type ENUM('Part Number', 'Vendor', 'PO Type', 'Part Category') NOT NULL COMMENT 'Type of pattern matching (e.g., Part Number, Vendor, PO Type, Part Category)',
    ...
    created_by INT NULL COMMENT 'FK toauth_users table (creator user id)',
...
-- ============================================================================
INSERT IGNORE INTO routing_home_locations (match_type, pattern, destination_location, priority, is_active) VALUES
