-- ============================================================================
-- Table: volvo_shipment_lines
-- Module: Volvo
-- Purpose: Individual part line items within a shipment
-- ============================================================================

DROP TABLE IF EXISTS volvo_shipment_lines;

CREATE TABLE IF NOT EXISTS volvo_shipment_lines (
    id INT NOT NULL AUTO_INCREMENT COMMENT 'Primary key for volvo_shipment_lines',
    shipment_id INT NOT NULL COMMENT 'FK to volvo_shipments.id (shipment header)',
