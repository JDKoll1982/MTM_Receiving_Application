DROP TABLE IF EXISTS volvo_part_components;
...
CREATE TABLE IF NOT EXISTS volvo_part_components (
    ...
    CONSTRAINT fk_volvo_part_components_parent FOREIGN KEY (parent_part_number) REFERENCES volvo_masterdata (part_number) ON DELETE CASCADE,
    CONSTRAINT fk_volvo_part_components_component FOREIGN KEY (component_part_number) REFERENCES volvo_masterdata (part_number) ON DELETE RESTRICT
