CREATE TABLE IF NOT EXISTS auth_users (
    ...
    pin VARCHAR(64) NOT NULL COMMENT 'One-way protected PIN value used for quick authentication at workstations',
    ...
    visual_username VARCHAR(256) NULL COMMENT 'Encrypted Infor Visual ERP username for integration (optional)',
    visual_password VARCHAR(256) NULL COMMENT 'Encrypted Infor Visual ERP password (optional)',
