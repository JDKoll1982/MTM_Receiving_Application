...
CREATE TABLE IF NOT EXISTS volvo_generated_label_history (
    ...
    archived_by VARCHAR(100) NOT NULL COMMENT 'Employee or workstation identity that archived the generated label rows',
    archive_batch_id CHAR(36) NOT NULL COMMENT 'UUID shared by all generated label rows moved in the same archive operation',
    PRIMARY KEY (id),
