...
CREATE TABLE IF NOT EXISTS volvo_line_history (
  ...
  po_status VARCHAR(20) NOT NULL DEFAULT 'Received' COMMENT 'Final card status after completion/archive',
  ...
  CONSTRAINT fk_volvo_line_history_header FOREIGN KEY (shipment_history_id) REFERENCES volvo_label_history (id) ON DELETE CASCADE
