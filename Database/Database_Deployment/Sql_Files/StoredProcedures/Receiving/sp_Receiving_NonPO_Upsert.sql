-- ============================================================
-- Procedure: sp_Receiving_NonPO_Upsert
-- Purpose:   Inserts a new receiving non-PO entry or increments
--            use_count when the same value already exists.
-- ============================================================

DROP PROCEDURE IF EXISTS `sp_Receiving_NonPO_Upsert`;

DELIMITER $$
CREATE PROCEDURE `sp_Receiving_NonPO_Upsert`(
