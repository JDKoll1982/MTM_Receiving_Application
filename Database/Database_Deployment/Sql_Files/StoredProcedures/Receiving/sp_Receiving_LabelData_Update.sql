...
CREATE PROCEDURE `sp_Receiving_LabelData_Update`(
    ...
    IN p_user_set_customer_name VARCHAR(255),
    IN p_user_set_variable VARCHAR(255),
...
BEGIN
    ...
    SET
        ...
        user_id = p_user_id,
        user_set_customer_name = p_user_set_customer_name,
        user_set_variable = p_user_set_variable,
        heat = p_heat,
