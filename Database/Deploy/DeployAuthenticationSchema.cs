    ...
    public class DeployAuthenticationSchema
    {
        ...
        private static async Task ExecuteSqlAsync(string sql)
        {
            ...
            foreach (var batch in batches)
            {
                ...
                if (string.IsNullOrWhiteSpace(cleanBatch) || cleanBatch.StartsWith("--")) continue;
                
                using var command = new MySqlCommand(cleanBatch, connection);
