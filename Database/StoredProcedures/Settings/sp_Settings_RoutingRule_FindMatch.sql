-- =============================================
-- Stored Procedure: sp_Settings_RoutingRule_FindMatch
-- =============================================
...
-- =============================================
DROP PROCEDURE IF EXISTS `sp_Settings_RoutingRule_FindMatch`$$
CREATE PROCEDURE `sp_Settings_RoutingRule_FindMatch`(
