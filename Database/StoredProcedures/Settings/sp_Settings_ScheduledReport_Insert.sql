-- =============================================
-- Stored Procedure: sp_Settings_ScheduledReport_Insert
-- =============================================
...
-- =============================================
DROP PROCEDURE IF EXISTS `sp_Settings_ScheduledReport_Insert`$$
CREATE PROCEDURE `sp_Settings_ScheduledReport_Insert`(
