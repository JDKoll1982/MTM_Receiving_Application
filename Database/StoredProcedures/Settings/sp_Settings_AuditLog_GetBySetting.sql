-- =============================================
-- Stored Procedure: sp_Settings_AuditLog_GetBySetting
-- =============================================
...
-- =============================================
DROP PROCEDURE IF EXISTS `sp_Settings_AuditLog_GetBySetting`$$
CREATE PROCEDURE `sp_Settings_AuditLog_GetBySetting`(
    IN p_setting_id INT,
    IN p_limit INT
)
BEGIN
