-- =============================================
-- Stored Procedure: sp_Settings_ScheduledReport_Update
-- =============================================
...
-- =============================================
DROP PROCEDURE IF EXISTS `sp_Settings_ScheduledReport_Update`$$
CREATE PROCEDURE `sp_Settings_ScheduledReport_Update`(
    IN p_id INT,
