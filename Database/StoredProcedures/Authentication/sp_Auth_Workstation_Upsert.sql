-- ============================================================================
-- Stored Procedure: sp_Auth_Workstation_Upsert
...
CREATE PROCEDURE `sp_Auth_Workstation_Upsert`(
...
-- ============================================================================
-- CALL sp_Auth_Workstation_Upsert('MYPC', 'personal_workstation', TRUE, 'Auto-registered on startup');
