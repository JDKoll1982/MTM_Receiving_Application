...
|------|-------|--------|------|-------------|--------------|
| Module_Settings\Data\Dao_ScheduledReport.cs | Dao_ScheduledReport | `InsertAsync` | 97 | ✓ | 21 |
| Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs | ViewModel_Settings_DatabaseTest | `TestStoredProceduresAsync` | 541 | ✓ | 1 |

## Code Samples

```csharp
// Module_Settings\Data\Dao_ScheduledReport.cs:97
"sp_ScheduledReport_Insert",

// Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs:541
"sp_ScheduledReport_Insert",
...
### Dao_ScheduledReport.InsertAsync
