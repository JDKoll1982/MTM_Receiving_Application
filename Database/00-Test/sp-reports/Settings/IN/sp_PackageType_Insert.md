...
|------|-------|--------|------|-------------|--------------|
| Module_Settings\Data\Dao_PackageType.cs | Dao_PackageType | `InsertAsync` | 71 | ✓ | 21 |
| Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs | ViewModel_Settings_DatabaseTest | `TestStoredProceduresAsync` | 518 | ✓ | 1 |

## Code Samples

```csharp
// Module_Settings\Data\Dao_PackageType.cs:71
"sp_PackageType_Insert",

// Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs:518
"sp_PackageType_Insert",
