...
|------|-------|--------|------|-------------|--------------|
| Module_Settings\Data\Dao_PackageTypeMappings.cs | Dao_PackageTypeMappings | `GetAllAsync` | 31 | ✓ | 21 |
| Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs | ViewModel_Settings_DatabaseTest | `TestStoredProceduresAsync` | 523 | ✓ | 1 |

## Code Samples

```csharp
// Module_Settings\Data\Dao_PackageTypeMappings.cs:31
"sp_PackageTypeMappings_GetAll",

// Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs:523
"sp_PackageTypeMappings_GetAll",
