...
|------|-------|--------|------|-------------|--------------|
| Module_Settings\Data\Dao_ScheduledReport.cs | Dao_ScheduledReport | `GetAllAsync` | 31 | ✓ | 21 |
| Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs | ViewModel_Settings_DatabaseTest | `TestStoredProceduresAsync` | 537 | ✓ | 1 |

## Code Samples

```csharp
// Module_Settings\Data\Dao_ScheduledReport.cs:31
"sp_ScheduledReport_GetAll",

// Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs:537
"sp_ScheduledReport_GetAll",
