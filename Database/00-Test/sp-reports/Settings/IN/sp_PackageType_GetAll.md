...
|------|-------|--------|------|-------------|--------------|
| Module_Settings\Data\Dao_PackageType.cs | Dao_PackageType | `GetAllAsync` | 31 | ✓ | 21 |
| Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs | ViewModel_Settings_DatabaseTest | `TestStoredProceduresAsync` | 516 | ✓ | 1 |

## Code Samples

```csharp
// Module_Settings\Data\Dao_PackageType.cs:31
"sp_PackageType_GetAll",

// Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs:516
"sp_PackageType_GetAll",
