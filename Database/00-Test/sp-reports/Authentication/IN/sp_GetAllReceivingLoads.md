...
|------|-------|--------|------|-------------|--------------|
| Module_Receiving\Data\Dao_ReceivingLoad.cs | Dao_ReceivingLoad | `GetAllAsync` | 243 | ✓ | 21 |

## Code Samples

```csharp
// Module_Receiving\Data\Dao_ReceivingLoad.cs:243
"sp_GetAllReceivingLoads",
