...
|------|-------|--------|------|-------------|--------------|
| Module_Settings\Data\Dao_RoutingRule.cs | Dao_RoutingRule | `UpdateAsync` | 96 | ✓ | 19 |
| Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs | ViewModel_Settings_DatabaseTest | `TestStoredProceduresAsync` | 534 | ✓ | 1 |

## Code Samples

```csharp
// Module_Settings\Data\Dao_RoutingRule.cs:96
"sp_RoutingRule_Update",

// Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs:534
"sp_RoutingRule_Update",
