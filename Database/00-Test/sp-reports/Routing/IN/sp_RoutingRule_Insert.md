...
|------|-------|--------|------|-------------|--------------|
| Module_Settings\Data\Dao_RoutingRule.cs | Dao_RoutingRule | `InsertAsync` | 73 | ✓ | 21 |
| Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs | ViewModel_Settings_DatabaseTest | `TestStoredProceduresAsync` | 533 | ✓ | 1 |

## Code Samples

```csharp
// Module_Settings\Data\Dao_RoutingRule.cs:73
"sp_RoutingRule_Insert",

// Module_Settings\ViewModels\ViewModel_Settings_DatabaseTest.cs:533
"sp_RoutingRule_Insert",
