...
|------|-------|--------|------|-------------|--------------|
| Module_Volvo\Data\Dao_VolvoPartComponent.cs | Dao_VolvoPartComponent | `InsertAsync` | 59 | ✓ | 21 |

## Code Samples

```csharp
// Module_Volvo\Data\Dao_VolvoPartComponent.cs:59
"sp_volvo_part_component_insert",
...
### Dao_VolvoPartComponent.InsertAsync
