...
|------|-------|--------|------|-------------|--------------|
| Module_Volvo\Data\Dao_VolvoShipmentLine.cs | Dao_VolvoShipmentLine | `DeleteAsync` | 105 | ✓ | 15 |

## Code Samples

```csharp
// Module_Volvo\Data\Dao_VolvoShipmentLine.cs:105
"sp_volvo_shipment_line_delete",
...
### Dao_VolvoShipmentLine.DeleteAsync
