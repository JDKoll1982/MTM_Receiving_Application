...
|------|-------|--------|------|-------------|--------------|
| Module_Volvo\Data\Dao_VolvoShipmentLine.cs | Dao_VolvoShipmentLine | `InsertAsync` | 45 | ✓ | 21 |
| Module_Volvo\Services\Service_Volvo.cs | Service_Volvo | `SaveShipmentAsync` | 685 | ✓ | 3 |

## Code Samples

```csharp
// Module_Volvo\Data\Dao_VolvoShipmentLine.cs:45
"sp_volvo_shipment_line_insert",

// Module_Volvo\Services\Service_Volvo.cs:685
"sp_volvo_shipment_line_insert",
...
### Dao_VolvoShipmentLine.InsertAsync
...
### Service_Volvo.SaveShipmentAsync
