...
|------|-------|--------|------|-------------|--------------|
| Module_Dunnage\Data\Dao_InventoriedDunnage.cs | Dao_InventoriedDunnage | `UpdateAsync` | 107 | ✓ | 19 |

## Code Samples

```csharp
// Module_Dunnage\Data\Dao_InventoriedDunnage.cs:107
"sp_dunnage_requires_inventory_update",
...
### Dao_InventoriedDunnage.UpdateAsync
