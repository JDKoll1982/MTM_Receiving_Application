...
|------|-------|--------|------|-------------|--------------|
| Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `InsertAsync` | 77 | ✓ | 21 |
| Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `InsertBatchAsync` | 132 | ✓ | 2 |
...
### Dao_DunnageLoad.InsertBatchAsync
