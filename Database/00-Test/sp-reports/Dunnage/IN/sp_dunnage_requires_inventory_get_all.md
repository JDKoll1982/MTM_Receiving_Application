...
|------|-------|--------|------|-------------|--------------|
| Module_Dunnage\Data\Dao_InventoriedDunnage.cs | Dao_InventoriedDunnage | `GetAllAsync` | 26 | ✓ | 21 |

## Code Samples

```csharp
// Module_Dunnage\Data\Dao_InventoriedDunnage.cs:26
"sp_dunnage_requires_inventory_get_all",
...
### Dao_InventoriedDunnage.GetAllAsync
