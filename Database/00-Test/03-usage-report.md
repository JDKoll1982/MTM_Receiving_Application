...
| [`sp_dunnage_history_delete`](sp-reports/Dunnage/IN/sp_dunnage_history_delete.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `DeleteAsync` | 176 | ✓ Yes | 15 |
| [`sp_dunnage_history_get_all`](sp-reports/Dunnage/IN/sp_dunnage_history_get_all.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `GetAllAsync` | 29 | ✓ Yes | 21 |
| [`sp_dunnage_history_get_by_date_range`](sp-reports/Dunnage/IN/sp_dunnage_history_get_by_date_range.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `GetByDateRangeAsync` | 44 | ✓ Yes | 2 |
| [`sp_dunnage_history_get_by_id`](sp-reports/Dunnage/IN/sp_dunnage_history_get_by_id.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `GetByIdAsync` | 59 | ✓ Yes | 13 |
| [`sp_dunnage_history_insert`](sp-reports/Dunnage/IN/sp_dunnage_history_insert.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `InsertAsync` | 77 | ✓ Yes | 21 |
| [`sp_dunnage_history_insert`](sp-reports/Dunnage/IN/sp_dunnage_history_insert.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `InsertBatchAsync` | 132 | ✓ Yes | 2 |
| [`sp_dunnage_history_insert_batch`](sp-reports/Dunnage/IN/sp_dunnage_history_insert_batch.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `InsertBatchAsync` | 132 | ✓ Yes | 2 |
| [`sp_dunnage_history_update`](sp-reports/Dunnage/IN/sp_dunnage_history_update.md) | Module_Dunnage\Data\Dao_DunnageLoad.cs | Dao_DunnageLoad | `UpdateAsync` | 162 | ✓ Yes | 19 |
