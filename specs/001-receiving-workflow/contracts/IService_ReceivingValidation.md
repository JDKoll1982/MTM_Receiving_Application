...
namespace MTM_Receiving_Application.Contracts.Services
{
    ...
    public interface IService_ReceivingValidation
    {
        ...
        ValidationResult ValidatePONumber(string poNumber);
        ...
        /// <returns>Validation result</returns>
        ValidationResult ValidateNumberOfLoads(int numLoads);
        ...
        /// <returns>Validation result</returns>
        ValidationResult ValidateWeightQuantity(decimal weightQuantity);
        ...
        /// <returns>Validation result</returns>
        ValidationResult ValidatePackageCount(int packagesPerLoad);
        ...
        /// <returns>Validation result</returns>
        ValidationResult ValidateHeatLotNumber(string heatLotNumber);
        ...
        Task<ValidationResult> ValidateAgainstPOQuantityAsync(
        ...
        Task<ValidationResult> CheckSameDayReceivingAsync(
            string poNumber, 
            string partID, 
        ...
        /// <returns>Validation result</returns>
        ValidationResult ValidateReceivingLoad(Model_ReceivingLoad load);
        ...
        ValidationResult ValidateSession(List<Model_ReceivingLoad> loads);
        ...
        /// <returns>Validation result</returns>
        Task<ValidationResult> ValidatePartExistsInVisualAsync(string partID);
    }
