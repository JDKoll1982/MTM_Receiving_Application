...
/// </summary>
public class RunSettingsDbTestCommandHandler
    : IRequestHandler<RunSettingsDbTestCommand, Model_Dao_Result<Model_SettingsDbTestReport>>
{
    ...
    public async Task<Model_Dao_Result<Model_SettingsDbTestReport>> Handle(
        RunSettingsDbTestCommand request,
    ...
    )
    {
        ...
        foreach (var table in expectedTables)
        {
            ...
            report.TableResults.Add(
                new Model_SettingsDbTableResult
                {
                    TableName = table,
                    IsValid = exists,
        ...
        foreach (var proc in expectedProcedures)
        {
            ...
            report.ProcedureResults.Add(
                new Model_SettingsDbProcedureResult
                {
                    ProcedureName = proc,
                    IsValid = exists,
                    Details = exists ? "Found" : "Missing",
        ...
        report.DaoResults.Add(
            new Model_SettingsDbDaoResult
            {
