...
public sealed partial class ViewModel_Settings_DeveloperTools_NavigationHub
        ...
        : base(pagination, errorHandler, logger, notificationService)
    {
        ...
        SetSteps(
            new Model_SettingsNavigationStep(
                "Overview",
                typeof(Views.View_Settings_DeveloperTools_SettingsOverview)
            ),
            new Model_SettingsNavigationStep(
                "Feature A",
                typeof(Views.View_Settings_DeveloperTools_FeatureA)
            ),
            new Model_SettingsNavigationStep(
                "Feature B",
                typeof(Views.View_Settings_DeveloperTools_FeatureB)
            ),
            new Model_SettingsNavigationStep(
                "Feature C",
                typeof(Views.View_Settings_DeveloperTools_FeatureC)
            ),
            new Model_SettingsNavigationStep(
                "Feature D",
                typeof(Views.View_Settings_DeveloperTools_FeatureD)
            ),
            new Model_SettingsNavigationStep(
                "Database Test",
                typeof(Views.View_SettingsDeveloperTools_DatabaseTest)
            )
        );
    }
