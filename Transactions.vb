...
htaFile.WriteLine "Dim sortColumn, sortAscending, searchMode, currentUser, currentPassword, currentQtyCache"
...
htaFile.WriteLine "ReDim tableData(1000, 13)"
htaFile.WriteLine "Set currentQtyCache = CreateObject(""Scripting.Dictionary"")"
htaFile.WriteLine ""
...
htaFile.WriteLine "End Sub"
htaFile.WriteLine ""
htaFile.WriteLine "Function EscapeSql(value)"
htaFile.WriteLine "    EscapeSql = Replace(CStr(value & """"), ""'"", ""''"")"
htaFile.WriteLine "End Function"
htaFile.WriteLine ""
htaFile.WriteLine "Function FormatSqlDateTime(value)"
htaFile.WriteLine "    If Not IsDate(value) Then"
htaFile.WriteLine "        FormatSqlDateTime = """""
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    value = CDate(value)"
htaFile.WriteLine "    FormatSqlDateTime = Year(value) & ""-"" & Right(""0"" & Month(value), 2) & ""-"" & Right(""0"" & Day(value), 2) & "" "" & Right(""0"" & Hour(value), 2) & "":"" & Right(""0"" & Minute(value), 2) & "":"" & Right(""0"" & Second(value), 2)"
htaFile.WriteLine "End Function"
htaFile.WriteLine ""
htaFile.WriteLine "Function GetCurrentLocationQty(partID, warehouseID, locationID)"
htaFile.WriteLine "    On Error Resume Next"
htaFile.WriteLine "    Dim cacheKey, rsQty, sqlQty"
htaFile.WriteLine "    cacheKey = EscapeSql(partID) & ""|"" & EscapeSql(warehouseID) & ""|"" & EscapeSql(locationID)"
htaFile.WriteLine "    If currentQtyCache.Exists(cacheKey) Then"
htaFile.WriteLine "        GetCurrentLocationQty = CDbl(currentQtyCache.Item(cacheKey))"
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    sqlQty = ""SELECT TOP 1 QTY FROM PART_LOCATION WHERE PART_ID = '"" & EscapeSql(partID) & ""' AND WAREHOUSE_ID = '"" & EscapeSql(warehouseID) & ""' AND LOCATION_ID = '"" & EscapeSql(locationID) & ""'"""
htaFile.WriteLine "    Set rsQty = conn.Execute(sqlQty)"
htaFile.WriteLine "    If Err.Number <> 0 Then"
htaFile.WriteLine "        Err.Clear"
htaFile.WriteLine "        GetCurrentLocationQty = 0"
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    If rsQty.EOF Or IsNull(rsQty(""QTY"")) Then"
htaFile.WriteLine "        GetCurrentLocationQty = 0"
htaFile.WriteLine "    Else"
htaFile.WriteLine "        GetCurrentLocationQty = CDbl(rsQty(""QTY""))"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    rsQty.Close"
htaFile.WriteLine "    currentQtyCache.Item(cacheKey) = GetCurrentLocationQty"
htaFile.WriteLine "End Function"
htaFile.WriteLine ""
htaFile.WriteLine "Function GetFutureLocationDelta(partID, warehouseID, locationID, transDate, transID)"
htaFile.WriteLine "    On Error Resume Next"
htaFile.WriteLine "    Dim rsDelta, sqlDelta, sqlDateText"
htaFile.WriteLine "    If Not IsDate(transDate) Then"
htaFile.WriteLine "        GetFutureLocationDelta = 0"
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    sqlDateText = FormatSqlDateTime(transDate)"
htaFile.WriteLine "    sqlDelta = ""SELECT ISNULL(SUM(CASE WHEN TYPE = 'I' THEN ABS(QTY) WHEN TYPE = 'O' THEN -ABS(QTY) ELSE 0 END), 0) AS FUTURE_DELTA "" & _"
htaFile.WriteLine "               ""FROM INVENTORY_TRANS WHERE PART_ID = '"" & EscapeSql(partID) & ""' "" & _"
htaFile.WriteLine "               ""AND WAREHOUSE_ID = '"" & EscapeSql(warehouseID) & ""' "" & _"
htaFile.WriteLine "               ""AND LOCATION_ID = '"" & EscapeSql(locationID) & ""' "" & _"
htaFile.WriteLine "               ""AND (COALESCE(CREATE_DATE, TRANSACTION_DATE) > '"" & sqlDateText & ""' "" & _"
htaFile.WriteLine "               ""OR (COALESCE(CREATE_DATE, TRANSACTION_DATE) = '"" & sqlDateText & ""' AND TRANSACTION_ID > "" & CLng(transID) & ""))"""
htaFile.WriteLine "    Set rsDelta = conn.Execute(sqlDelta)"
htaFile.WriteLine "    If Err.Number <> 0 Then"
htaFile.WriteLine "        Err.Clear"
htaFile.WriteLine "        GetFutureLocationDelta = 0"
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    If rsDelta.EOF Or IsNull(rsDelta(""FUTURE_DELTA"")) Then"
htaFile.WriteLine "        GetFutureLocationDelta = 0"
htaFile.WriteLine "    Else"
htaFile.WriteLine "        GetFutureLocationDelta = CDbl(rsDelta(""FUTURE_DELTA""))"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    rsDelta.Close"
htaFile.WriteLine "End Function"
htaFile.WriteLine ""
htaFile.WriteLine "Function GetLocationBalanceInfo(partID, warehouseID, locationID, transDate, transID, transType, qtyValue)"
htaFile.WriteLine "    Dim balanceInfo(1)"
htaFile.WriteLine "    balanceInfo(0) = """""
htaFile.WriteLine "    balanceInfo(1) = """""
htaFile.WriteLine "    If Trim(CStr(partID & """")) = """" Then"
htaFile.WriteLine "        GetLocationBalanceInfo = balanceInfo"
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    If Trim(CStr(warehouseID & """")) = """" Or Trim(CStr(locationID & """")) = """" Then"
htaFile.WriteLine "        GetLocationBalanceInfo = balanceInfo"
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    If Not IsNumeric(qtyValue) Then"
htaFile.WriteLine "        GetLocationBalanceInfo = balanceInfo"
htaFile.WriteLine "        Exit Function"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    Dim currentQty, futureDelta, qtyAfter, qtyBefore, signedDelta"
htaFile.WriteLine "    currentQty = GetCurrentLocationQty(partID, warehouseID, locationID)"
htaFile.WriteLine "    futureDelta = GetFutureLocationDelta(partID, warehouseID, locationID, transDate, transID)"
htaFile.WriteLine "    qtyAfter = currentQty - futureDelta"
htaFile.WriteLine "    signedDelta = Abs(CDbl(qtyValue))"
htaFile.WriteLine "    If UCase(CStr(transType)) = ""O"" Then"
htaFile.WriteLine "        signedDelta = -signedDelta"
htaFile.WriteLine "    ElseIf UCase(CStr(transType)) <> ""I"" Then"
htaFile.WriteLine "        signedDelta = 0"
htaFile.WriteLine "    End If"
htaFile.WriteLine "    qtyBefore = qtyAfter - signedDelta"
htaFile.WriteLine "    balanceInfo(0) = FormatNumber(qtyBefore, 2)"
htaFile.WriteLine "    balanceInfo(1) = FormatNumber(qtyAfter, 2)"
htaFile.WriteLine "    GetLocationBalanceInfo = balanceInfo"
htaFile.WriteLine "End Function"
htaFile.WriteLine ""
htaFile.WriteLine "Sub LoadData"
htaFile.WriteLine "    On Error Resume Next"
htaFile.WriteLine "    Dim partID, rs, sql, fromDate, toDate, balanceInfo"
htaFile.WriteLine "    "
...
htaFile.WriteLine "    currentQtyCache.RemoveAll"
htaFile.WriteLine "    "
htaFile.WriteLine "    Set conn = CreateObject(""ADODB.Connection"")"
htaFile.WriteLine "    conn.ConnectionString = ""Provider=SQLOLEDB;Data Source=VISUAL;Initial Catalog=MTMFG;ApplicationIntent=ReadOnly;User ID="" & currentUser & "";Password="" & currentPassword & "";"""
...
htaFile.WriteLine "          ""FROM INVENTORY_TRANS WHERE PART_ID = '"" & EscapeSql(partID) & ""'"""
htaFile.WriteLine "    "
...
htaFile.WriteLine "            End If"
htaFile.WriteLine "            balanceInfo = GetLocationBalanceInfo(currentPartID, tableData(rowCount, 5), tableData(rowCount, 6), tableData(rowCount, 10), tableData(rowCount, 0), rs(""TYPE""), tableData(rowCount, 4))"
htaFile.WriteLine "            If tableData(rowCount, 11) = ""transfer-in"" Or tableData(rowCount, 11) = ""transfer-out"" Then"
htaFile.WriteLine "                tableData(rowCount, 12) = balanceInfo(0)"
htaFile.WriteLine "                tableData(rowCount, 13) = balanceInfo(1)"
htaFile.WriteLine "            Else"
htaFile.WriteLine "                tableData(rowCount, 12) = """""
htaFile.WriteLine "                tableData(rowCount, 13) = """""
htaFile.WriteLine "            End If"
htaFile.WriteLine "            "
...
htaFile.WriteLine "    On Error Resume Next"
htaFile.WriteLine "    Dim rs, sql, balanceInfo"
htaFile.WriteLine "    "
...
htaFile.WriteLine "          ""AND USER_ID = '"" & EscapeSql(currentUser) & ""' "" & _"
...
htaFile.WriteLine "    ReDim rawData(200, 13)"
htaFile.WriteLine "    "
htaFile.WriteLine "    If Not rs.EOF Then"
...
htaFile.WriteLine "            balanceInfo = GetLocationBalanceInfo(rawData(rawCount, 9), rawData(rawCount, 5), rawData(rawCount, 11), rawData(rawCount, 10), rawData(rawCount, 0), rawData(rawCount, 3), rawData(rawCount, 4))"
htaFile.WriteLine "            rawData(rawCount, 12) = balanceInfo(0)"
htaFile.WriteLine "            rawData(rawCount, 13) = balanceInfo(1)"
htaFile.WriteLine "            "
...
htaFile.WriteLine "                For k = 0 To 13"
...
htaFile.WriteLine "                tableData(rowCount, 11) = ""transfer-out"""
htaFile.WriteLine "                tableData(rowCount, 12) = ""From "" & rawData(i, 12) & "" | To "" & rawData(bestMatch, 12)"
htaFile.WriteLine "                tableData(rowCount, 13) = ""From "" & rawData(i, 13) & "" | To "" & rawData(bestMatch, 13)"
htaFile.WriteLine "                used(i) = 1"
...
htaFile.WriteLine "                tableData(rowCount, 11) = ""transfer-out"""
htaFile.WriteLine "            End If"
htaFile.WriteLine "            tableData(rowCount, 12) = rawData(i, 12)"
htaFile.WriteLine "            tableData(rowCount, 13) = rawData(i, 13)"
htaFile.WriteLine "            rowCount = rowCount + 1"
htaFile.WriteLine "        End If"
htaFile.WriteLine "    Next"
htaFile.WriteLine "End Sub"
...
htaFile.WriteLine "    tableHTML = tableHTML & ""<th>Before Qty</th>"""
htaFile.WriteLine "    tableHTML = tableHTML & ""<th>After Qty</th>"""
...
htaFile.WriteLine "        tableHTML = tableHTML & ""<td>"" & tableData(i, 12) & ""</td>"""
htaFile.WriteLine "        tableHTML = tableHTML & ""<td>"" & tableData(i, 13) & ""</td>"""
...
htaFile.WriteLine "        tableHTML = tableHTML & ""<td>"" & tableData(i, 7) & ""</td>"""
htaFile.WriteLine "        tableHTML = tableHTML & ""<td>"" & tableData(i, 8) & ""</td>"""
htaFile.WriteLine "        tableHTML = tableHTML & ""<td align='right'>"" & tableData(i, 12) & ""</td>"""
htaFile.WriteLine "        tableHTML = tableHTML & ""<td align='right'>"" & tableData(i, 13) & ""</td>"""
htaFile.WriteLine "        tableHTML = tableHTML & ""</tr>"""
htaFile.WriteLine "    Next"
htaFile.WriteLine "    "
htaFile.WriteLine "    tableHTML = tableHTML & ""</tbody></table>"""
...
htaFile.WriteLine "    exportText = exportText & ""Reference"" & vbTab & ""User"" & vbTab & ""Before Qty"" & vbTab & ""After Qty"" & vbCrLf"
htaFile.WriteLine "    "
htaFile.WriteLine "    For i = 0 To rowCount - 1"
...
htaFile.WriteLine "        exportText = exportText & tableData(i, 8) & vbTab"
htaFile.WriteLine "        exportText = exportText & tableData(i, 12) & vbTab"
htaFile.WriteLine "        exportText = exportText & tableData(i, 13) & vbCrLf"
htaFile.WriteLine "    Next"
htaFile.WriteLine "    "
