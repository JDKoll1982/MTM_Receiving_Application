...
- [MVVM Pattern Instructions](.github/instructions/architecture/mvvm-pattern.instructions.md)
- [DAO Pattern Instructions](.github/instructions/architecture/dao-pattern.instructions.md)
