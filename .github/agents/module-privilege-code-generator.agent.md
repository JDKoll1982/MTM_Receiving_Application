---
description: "Generates authorization code from PRIVILEGES.md (RBAC)."
...
1. LOAD the FULL agent file from @_bmad/module-agents/agents/privilege-code-generator.md
