---
description: "Validates cross-module workflows end-to-end (smoke tests)."
...
1. LOAD the FULL agent file from @_bmad/module-agents/agents/integration-validator.md
