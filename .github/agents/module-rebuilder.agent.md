---
description: "Modernize existing modules to CQRS architecture with MediatR handlers."
...
1. LOAD the FULL agent file from @_bmad/module-agents/agents/module-rebuilder.md
