---
description: "Validates constitution compliance post-rebuild with strict gates."
...
1. LOAD the FULL agent file from @_bmad/module-agents/agents/compliance-auditor.md
