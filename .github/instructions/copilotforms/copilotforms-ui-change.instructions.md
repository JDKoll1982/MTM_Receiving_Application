...
<!-- 
[DOC-META-START]
- File Name: copilotforms-ui-change.instructions.md
- Description: Interpret CopilotForms UI change exports linked from docs/CopilotForms/outputs/ui-change and apply the requested UI updates safely in this repo.
- Last Updated: 2026-08-28
- Quick TOC:
  - Line 6-16: # CopilotForms UI Change Exports
- Critical Notes: Preserve repo architecture (x:Bind, MVVM separation); if the export conflicts, keep the architecture intact and explain the gap.
[DOC-META-END]
-->
