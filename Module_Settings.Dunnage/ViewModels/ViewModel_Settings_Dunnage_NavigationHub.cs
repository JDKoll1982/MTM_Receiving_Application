...
public sealed partial class ViewModel_Settings_Dunnage_NavigationHub
        ...
        : base(pagination, errorHandler, logger, notificationService)
    {
        ...
        SetSteps(
            new Model_SettingsNavigationStep(
                "Overview",
                typeof(Views.View_Settings_Dunnage_SettingsOverview)
            ),
            new Model_SettingsNavigationStep(
                "User Preferences",
                typeof(Views.View_Settings_Dunnage_UserPreferences)
            ),
            new Model_SettingsNavigationStep("UI/UX", typeof(Views.View_Settings_Dunnage_UiUx)),
            new Model_SettingsNavigationStep(
                "Workflow",
                typeof(Views.View_Settings_Dunnage_Workflow)
            ),
            new Model_SettingsNavigationStep(
                "Permissions",
                typeof(Views.View_Settings_Dunnage_Permissions)
            ),
