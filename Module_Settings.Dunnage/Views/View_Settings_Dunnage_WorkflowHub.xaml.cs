...
public sealed partial class View_Settings_Dunnage_NavigationHub : Page
{
    public ViewModel_Settings_Dunnage_NavigationHub ViewModel { get; }
    ...
    public View_Settings_Dunnage_NavigationHub(ViewModel_Settings_Dunnage_NavigationHub viewModel)
    {
        InitializeComponent();
        ViewModel = viewModel;
        ...
        try
        {
            ...
            if (hostField?.GetValue(app) is object host)
            {
                ...
                {
                    _logger = services.GetService<IService_LoggingUtility>();
                    _logger?.LogInfo(
                        "View_Settings_Dunnage_NavigationHub initialized",
                        "Settings.Navigation"
                    );
                }
            }
    ...
    private void OnStepClicked(object sender, RoutedEventArgs e)
    {
        ...
        var step =
            button.Content as Model_SettingsNavigationStep
