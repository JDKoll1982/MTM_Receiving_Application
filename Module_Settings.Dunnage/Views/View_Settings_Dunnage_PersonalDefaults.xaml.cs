...
public sealed partial class View_Settings_Dunnage_PersonalDefaults : Page
{
    public ViewModel_Settings_Dunnage_PersonalDefaults ViewModel { get; }

    public View_Settings_Dunnage_PersonalDefaults(
        ViewModel_Settings_Dunnage_PersonalDefaults viewModel
    )
    {
