...
/// </summary>
public class DeletePendingShipmentCommandHandler : IRequestHandler<DeletePendingShipmentCommand, Model_Dao_Result>
{
    ...
    public async Task<Model_Dao_Result> Handle(DeletePendingShipmentCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            {
                return Model_Dao_Result_Factory.Failure("You are not authorized to delete pending shipments");
            }
        ...
        catch (Exception ex)
        {
            return Model_Dao_Result_Factory.Failure(
                $"Unexpected error deleting pending shipment: {ex.Message}", ex);
        }
    }
}