...
public class Dao_DunnagePart
{
    ...
    public virtual async Task<Model_Dao_Result<int>> InsertAsync(string partId, int typeId, string specValues, string user)
    {
    ...
    public virtual async Task<Model_Dao_Result> UpdateAsync(int id, string specValues, string user)
    {
        var parameters = new Dictionary<string, object>
        {
            { "id", id },
