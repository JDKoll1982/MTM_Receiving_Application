...
public sealed partial class ViewModel_Settings_Receiving_ValidationRules : ViewModel_Shared_Base
{
    ...
    public ViewModel_Settings_Receiving_ValidationRules(
        ...
        : base(errorHandler, logger, notificationService)
    {
        ...
        Title = "Receiving Validation Rules";
        _ = LoadSettingsAsync();
    }
    ...
    private async Task SaveAsync()
    {
        try
        {
            ...
            ShowStatus("Receiving validation rules saved.");
        }
        catch (Exception ex)
        {
            await _errorHandler.HandleErrorAsync(
                "Failed to save receiving validation rules.",
    ...
    private async Task ResetAsync()
    {
        try
        {
            ...
            ShowStatus("Receiving validation rules reset.");
        }
        catch (Exception ex)
        {
            await _errorHandler.HandleErrorAsync(
                "Failed to reset receiving validation rules.",
                Enum_ErrorSeverity.Error,
                ex
            );
        }
    ...
    private async Task LoadSettingsAsync()
    {
        ...
        {
            await _errorHandler.HandleErrorAsync(
                "Failed to load receiving validation rules.",
