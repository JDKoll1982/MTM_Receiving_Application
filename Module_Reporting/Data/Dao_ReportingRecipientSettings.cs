...
/// <summary>
/// Data access for Reporting email-recipient settings.
/// </summary>
public class Dao_ReportingRecipientSettings
{
    private readonly string _connectionString;

    public Dao_ReportingRecipientSettings(string connectionString)
    {
        _connectionString =
