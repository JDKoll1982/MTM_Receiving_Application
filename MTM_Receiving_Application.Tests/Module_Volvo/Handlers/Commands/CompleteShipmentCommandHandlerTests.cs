...
/// <summary>
/// Integration tests for CompleteShipmentCommandHandler.
/// </summary>
[Collection("Database")]
public class CompleteShipmentCommandHandlerTests
{
    ...
    public CompleteShipmentCommandHandlerTests(DatabaseFixture fixture)
    {
        _fixture = fixture;
    }

    [Fact]
    public async Task Handle_ShouldCompleteShipment()
    {
