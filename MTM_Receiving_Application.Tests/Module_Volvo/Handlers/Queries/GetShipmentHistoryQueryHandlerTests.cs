...
/// <summary>
/// Integration tests for GetShipmentHistoryQueryHandler.
/// </summary>
[Collection("Database")]
public class GetShipmentHistoryQueryHandlerTests
{
    ...
    public GetShipmentHistoryQueryHandlerTests(DatabaseFixture fixture)
    {
        _fixture = fixture;
    }

    [Fact]
    public async Task Handle_ShouldReturnHistoryWithinDateRange()
    {
